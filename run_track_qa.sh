...
OPTION="-b --configuration json://753916_config.json"
...
o2-analysis-je-track-efficiency ${OPTION} --aod-file 559613/AO2D_013.root --shm-segment-size 16000000000 --min-failure-level error